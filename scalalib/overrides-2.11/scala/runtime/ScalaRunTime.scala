...
object ScalaRunTime {
  ...
  @noinline private def throwNullPointerException(): Nothing =
    throw new NullPointerException

  /** Retrieve generic array element */
  @inline def array_apply(xs: AnyRef, idx: Int): Any = xs match {
    case xs: scalanative.runtime.Array[_] =>
      xs(idx)
    case null =>
  ...
  @inline def array_update(xs: AnyRef, idx: Int, value: Any): Unit = xs match {
    case xs: scalanative.runtime.Array[t] =>
      xs(idx) = value.asInstanceOf[t]
    case null =>
      throwNullPointerException()
  }

  /** Get generic array length */
  @inline def array_length(xs: AnyRef): Int = xs match {
    case xs: scalanative.runtime.Array[_] =>
      xs.length
    case null =>
      throwNullPointerException()
  ...
  @inline def array_clone(xs: AnyRef): AnyRef = xs match {
    case xs: scalanative.runtime.Array[_] =>
      xs.clone()
    case null =>
      throwNullPointerException()
