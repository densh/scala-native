...
object Val {
  ...
  final case class Zero(of: nir03.Type)      extends Val
  final case class Undef(of: nir03.Type)     extends Val
  ...
  final case class Struct(name: nir03.Global, values: Seq[Val])  extends Val
  final case class Array(elemty: nir03.Type, values: Seq[Val])   extends Val
  final case class Chars(value: java.lang.String)                extends Val
  final case class Local(name: nir03.Local, valty: nir03.Type)   extends Val
  final case class Global(name: nir03.Global, valty: nir03.Type) extends Val
