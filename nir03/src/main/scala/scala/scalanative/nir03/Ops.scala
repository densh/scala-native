...
object Op {
  ...
  final case class Bin(bin: nir03.Bin, ty: Type, l: Val, r: Val)    extends Pure
  final case class Comp(comp: nir03.Comp, ty: Type, l: Val, r: Val) extends Pure
  final case class Conv(conv: nir03.Conv, ty: Type, value: Val)     extends Pure
