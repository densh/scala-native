...
object Tags {
  ...
  final val ArrayallocOp  = 1 + DynmethodOp
  final val ArraylengthOp = 1 + ArrayallocOp
  final val ArrayatOp     = 1 + ArraylengthOp
  final val ArrayloadOp   = 1 + ArrayatOp
  ...
  final val ArrayClassType = 1 + ModuleType
