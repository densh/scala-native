...
object ScalaNativePluginInternal {
  ...
  lazy val scalaNativeBaseSettings: Seq[Setting[_]] = Seq(
    ...
    nativeInlineCachingMode := NoInlineCaching,
    nativeInlineCachingMode in NativeTest := (nativeInlineCachingMode in Test).value,
    nativePruneUntakenBranches := false,
    nativePruneUntakenBranches in NativeTest := (nativePruneUntakenBranches in Test).value,
    nativeProfileDirectedInlining := false,
    nativeProfileDirectedInlining in NativeTest := (nativeProfileDirectedInlining in Test).value,
    nativeProfileDirectedBlockPlacement := false,
    nativeProfileDirectedBlockPlacement in NativeTest := (nativeProfileDirectedBlockPlacement in Test).value
  )
  ...
  lazy val scalaNativeConfigSettings: Seq[Setting[_]] = Seq(
    ...
    nativeConfig := {
      ...
      val ic        = nativeInlineCachingMode.value
      val prune     = nativePruneUntakenBranches.value
      val inline    = nativeProfileDirectedInlining.value
      val pgbp      = nativeProfileDirectedBlockPlacement.value
      ...
      tools.Config.empty
        ...
        .withInlineCachingMode(ic)
        .withPruneUntakenBranches(prune)
        .withProfileDirectedInlining(inline)
        .withProfileDirectedBlockPlacement(pgbp)
    },
    nativeUnpackLib := {
      val cwd       = nativeWorkdir.value
      val logger    = streams.value.log
