...
inline int stack_push(Stack *stack, Stack_Type word) {
...
inline int stack_is_empty(Stack *stack) { return stack->current == 0; }

inline void stack_double_size(Stack *stack) {
    assert(stack->current == 0);
